...
const certificate = {
  ...
  desc:
    "Audubon International mission is to create environmentally sustainable environments where people live, work, and play",
};


const audubon = new Promise(async (resolve, reject) => {
  try {
    const url="https://directory.auduboninternational.org/directory?memberCategory=&city=&state=&country=&zipcode=&current_page="
    ...
    var company = await page.evaluate(() => {
      var companyList = document.querySelectorAll('div[class="directory-card"]> h5');
      var CompanyArray = [];
